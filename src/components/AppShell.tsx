...
import { CalendarDays, ClipboardCheck, Cog, ListChecks, LogOut, ShieldCheck, Timer, Users, Warehouse } from "lucide-react";
...
const adminLinks = [
  ...
  { href: "/admin/prestart-items", label: "Checklist", icon: ListChecks },
